...
[Link to working code (legacy Java client)](../source/java/src/main/java/com/aerospike/examples/manytomany/ManyToManyRelationships.java) | [Link to working code (Java SDK)](../source/java-sdk/src/main/java/com/aerospike/examples/manytomany/ManyToManyRelationships.java) | [Link to working code (Python SDK)](../source/python-sdk/usecasecookbook/manytomany/many_to_many_relationships.py)
