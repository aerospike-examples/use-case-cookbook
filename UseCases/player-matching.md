...
[Link to working code (legacy Java client)](../source/java/src/main/java/com/aerospike/examples/gaming/PlayerMatching.java) | [Link to working code (Java SDK)](../source/java-sdk/src/main/java/com/aerospike/examples/gaming/PlayerMatching.java) | [Link to working code (Python SDK)](../source/python-sdk/usecasecookbook/gaming/player_matching.py)
