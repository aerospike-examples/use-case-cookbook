...
[Link to working code (legacy Java client)](../source/java/src/main/java/com/aerospike/examples/timeseries/TimeSeriesLargeVarianceDemo.java) | [Link to working code (Java SDK)](../source/java-sdk/src/main/java/com/aerospike/examples/timeseries/TimeSeriesLargeVarianceDemo.java) | [Link to working code (Python SDK)](../source/python-sdk/usecasecookbook/timeseries/time_series_large_variance_demo.py)
