...
public class InteractiveMenu {
    ...
    private void showStartHeader() {
        System.out.println();
        System.out.println(AnsiColors.BOLD + "Aerospike Use Case Cookbook (Java SDK)" + AnsiColors.RESET);
        System.out.println("==============================");
        System.out.println();
    }
    ...
    private void showUseCaseDetails(int width, boolean summary) {
        ...
        for (int i = 0; i < filteredUseCases.size(); i++) {
            ...
            String color = (i % 2 == 0) ? AnsiColors.COLOR2 : AnsiColors.COLOR1;
    ...
    private void invokeUseCase(int selection) {
        ...
        executor.executeUseCase(uc, true, false, false);
    }
