package com.aerospike.examples.realtimebidding;
...
public class RealTimeBiddingDemo implements UseCase {
    @Override
    public String getName() {
        return "Real time bidding";
    }

    @Override
    public String getDescription() {
        return "Real time bidding in ad-tech ";
    }
